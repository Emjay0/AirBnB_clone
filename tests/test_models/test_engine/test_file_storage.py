...
class TestFileStorage(unittest.TestCase):
    ...
    def test_all(self):
        ...
        fs2.new(bm1)
        fs2.new(bm2)
        self.assertEqual(fs2.all(), {'BaseModel.' + bm1.id: bm1, 'BaseModel.'
                                     + bm2.id: bm2})
    ...
    def test_new(self):
        """ test new """
        dic = {"id": "8d8b4200-z106-469d-aec9-70zae1224150", "__class__":
               "BaseModel", "updated_at": "2020-07-01T16:47:21.260793",
